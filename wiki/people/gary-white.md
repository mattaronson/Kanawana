...
Oral history originally recorded White's Kanawana tenure as running from 2001 to 2005. Per the operator's standing policy that documented sources take precedence over oral history where the two directly conflict, this article follows the annual reports' narrower, independently corroborated FY2001–2002 window; the oral-history-recorded 2001–2005 span is preserved in the KB as a superseded record, not deleted. See [[people/directors-index|Directors and Staff of Camp Kanawana]]'s Revision History for the full resolution record (conflict c_015).

## Open Questions

1. [Important] Whether the annual reports' single "Director" listing for Kanawana in FY2001-2002 tracks the Executive Director tier or the on-site Director tier (the two-tier split is documented from 1995 onward, but the annual reports themselves show only one "Director" per branch, not an explicit two-tier structure) remains an open structural question.
2. [Nice-to-have] No biographical detail beyond his YMCA branch-director career (Kanawana, then Westmount) has been found for White — no obituary, LinkedIn profile, or other independent record.
...
<!-- RALPH process log (informal, not reader-facing). This article synthesizes an already-documented table row in directors-index.md's "Two-Tier Era" Executive Directors table (facts f_1731, f_1749, f_1750, f_1751, f_1760), the product of the R13/R14 direct-fetch annual-report verification campaigns (2026-07-07) that resolved conflict c_015 in favour of the documented dates per the operator's standing oral-history-vs-document policy. No new web research was conducted for this spawn. Kept at "stub" status (not draft) given the genuine thinness of independent biographical material beyond the annual-report tenure records -- consistent with the plan's own characterization of White as "thinner" than the other institutional-role director candidates. -->
