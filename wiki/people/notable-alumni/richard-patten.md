...
1. Obituary for Richard Andrew Patten (HP McGarry) [src_patten_obituary].
2. YMCA Quebec, "ALS Advocate Carol Skinner Receives Camp YMCA Kanawana Pip Alumni Award" (2016), Pip Award recipient list [src_ymca_quebec_pip_skinner].
3. Kanawana Flickr "Plaque" album, "Advance Guard '63" plaque [src_flickr_kanawana_plaque_album].
4. Obituary for Richard Andrew Patten (HP McGarry), YMCA day-camp employment [src_patten_obituary].
...
<!-- RALPH process log (informal, not reader-facing). This article synthesizes an already-documented paragraph in notable-alumni.md (facts f_0448, f_0467, f_0610, f_1067, f_1079, f_1089, f_1090, f_1091, f_1127, f_1588). No new web research was conducted for this spawn. While preparing this article, two facts (f_1089, f_1127) were found citing the non-existent source_ids "src_patten_wikipedia" and "src_hpmcgarry_patten_obituary" -- both typo'd variants of the already-cached, already-verified "src_wikipedia_richard_patten" and "src_patten_obituary" records -- and have been remapped in kb/facts.json. No claim content was altered, only the broken source pointers. notable-alumni.md's entry has been trimmed accordingly and now points here. -->

<!-- FOLDER PLACEMENT, 2026-08-14 (p_230, operator concurrence): MOVED from core people/ to people/notable-alumni/.
     Patten passes the CLAUDE.md test cleanly: Liberal MPP for Ottawa Centre (1987-90, 1995-2007), a documented public career that would warrant an article whether or not Kanawana existed. His YMCA connection is real but organizationally adjacent -- the 1976-1979 role was Executive Director of the Centre-ville/Downtown branch, an office with NO line authority over the camp (Camping and Outdoor Education was a separate parallel branch). He held no camp role.
     This move corrects the mirror-image error to the sam-lazarus one: a person whose defining life is lived outside camp had been filed as core, while a person whose significance is entirely a camp institution had been filed as an outside notable. -->
