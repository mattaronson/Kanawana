...
The cycle produced exactly one new trace, and it is not from the camping press: **CBC News's 2017 report on the Stuart McLean Camp Kanawana Fund appears to credit its photographs of McLean's camp years to Derek Walsh.** If that holds, Kanawana's director of 1974–79 was still connected to the camp's alumni network forty years later and holds private photographs of the camp's most famous camper. **It has not been read**: cbc.ca returns HTTP 403 to this project's fetch tool, so the credit line is known only from a search-result summary and is recorded at that strength [f_4826].^14
...
Almost none of this is visible from Kanawana's own records. It comes from *Canadian Camping*, which names him twenty-four times across eighteen issues, never once beside the word Kanawana.^2
...
| **Spring 1982** | Carries out the CCA's feasibility study on publishing a Canadian camping magazine — Jocelyn Palm's President's Perspective lists him among the national task force leaders as "**Derek Walsh (Qué.) is investigating the realities of publishing a Canadian Camping Magazine**"^2 ^11 |
| **29 Jan 1983** | Awarded the **CCA Certificate of Appreciation**^2 |

### The magazine study, and what came of it

The task force report is printed in full over his name in the association's 1981-82 Annual Report, and it is the longest piece of Walsh's own writing this project holds.^12 He was "mandated to study the feasibility of the CCA (re)launching a magazine", and investigated "**circulation, advertising, format, editorial policy, financial implications**". His conclusion was against a magazine and for three specific changes to the newsletter:

> "The results of the study essentially suggest that **the CCA should not re-launch its magazine per se, but should make some distinct and conscious efforts to broaden/change its current 'newsletter' in three (3) areas: 1) Initiate a major subscription campaign to attract as many camp staff subscribers as possible. 2) Establish an editorial policy to reflect the change in readership. 3) Actively seek advertising revenue with a view to having the publication be a revenue generator.** … The CCA has the potential to make some significant improvements with its publication, and at the same time, move towards the establishment of a small financial resource."

**It was acted on.** The editor's report on the facing pages of the same issue records the newsletter typeset in a new format "to upgrade and improve the quality of our product and to be able to put more information on our pages"; a named editorial board and a **stated editorial policy printed in every issue**; sixteen pages an issue and four issues a year, with subscription rates reviewed annually; and, on advertising, "when we have a few more issues published, we then hope to **chase advertisers** with a product they would 'want' to be a part of. This will be a 1982-83 initiative."^12 Walsh's three recommendations and the editor's three actions are the same three.

The practical consequence for this project is worth stating: the form of *Canadian Camping* from 1982 onward — the form of the sources this wiki has been citing throughout its later run — was determined by a study written by a man who had directed Kanawana five years earlier.
...
The association's own **October 1981 publications catalogue** then lists it under his name, in both languages and both series pages: "***'How to Promote Your Camp' — D. Walsh, CCA/ACC, 1981***" and "***'Comment promouvir votre camp vacances' — D. Walsh, CCA/ACC, 1981***", each marked with the asterisk the catalogue reserves for Canadian books, at 75¢, with "both titles and a C.C.A. three ring binder" for $4.00.^10 That is the first statement of his authorship as authorship rather than as an inference from the committee he chaired, and it makes him one of only about fifteen Canadian authors on a list of more than a hundred titles. The companion monograph, "Composting for Pleasure and Profit", is by **S. Hambly** of Downsview, Ontario. The **1982-83 catalogue** completes the picture: the series had reached **six titles within eighteen months**, all bilingual, described as "**4 or 6 page monographs**" — Walsh's and Hambly's at 75¢ from 1981, and four more at $1.00 from 1982 by **Marjorie Booth** (the association's executive director), **Jocelyn Palm** (its president), **Catherine Thomas** and **Mors Kochanski**.^13 The binder that came with them was "a good quality, dark green plastic binder" at $4.00 including any two monographs, not sold separately. So the pamphlet Walsh wrote opened a series the association's own senior officers then wrote for.
...
1. Directors index, from the YMCA of Montreal annual reports [src_ia_ymca_montreal_annual_reports_collection].
2. *Canadian Camping* / *Canadian Camping Magazine*, 1976–1985 [src_ia_canadian_camping_collection]: the October 1976 association directory; June 1979 installation report; the 1980 committee list; the December 1980 and May 1981 President's Reports; the publications catalogue in the 1982 insert and the autumn 1984 and 1985 issues; the spring 1983 Certificate of Appreciation notice; and the May 1979 international-event report. Full text cached under `sources/cache/canadian-camping/`. See [f_2468], [f_2469], [f_2470].
...
10. "Publications" (the "HOW TO" / "COMMENT FAIRE" series announcement), *Canadian Camping* Vol. 33 No. 4 (June 1981), p. 5, with Cliff Labbett's President's Report on the federal review and the call for monograph authors, Vol. 33 No. 3 (May 1981), p. 2 [src_ia_canadian_camping_collection]. Found by the same read (issues 137 and 138) The catalogue entries naming him as author are in the C.C.A. publications catalogue printed as Vol. 33 No. 5 (October 1981), catalogue pp. 4 and 7 (issue 139).
11. Jocelyn Palm, "President's Perspective," *Canadian Camping* Vol. 34 No. 1 (Spring 1982), p. 6 [src_ia_canadian_camping_collection]. Found by the same read (issue 141). The national president's own list of committee and task force chairmen with their provinces.
...
<!-- Spawned 2026-09-04 from the Canadian Camping re-read (p_304). Enters at STUB
     deliberately, on the Part 5 precedent: it clears the structural draft bar but has
     had no RALPH cycle, and the last batch of people articles marked draft on structure
     alone failed VERIFY with 48 blocking findings between them.

     The reason this article exists is itself the finding. Kanawana's own records show a
     competent director. The camping press shows a man running the national association's
     public relations for seven years, writing its promotion pamphlet in both languages and
     assessing whether it could publish a magazine -- and it shows none of it next to the
     camp's name, which is why a name-based search over the same 164 issues found the
     obituaries and biographies and missed this entirely. See f_2474. -->
