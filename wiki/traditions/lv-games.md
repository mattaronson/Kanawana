...
This article has always described the Pine Crest borrowing from the outside, on the strength of a commemorative book and a YMCA blog.^3 ^4 The ceremony itself is now on record, described by the man who ran the camp. **W. E. "Ted" Yard** — Director of Camp Pine Crest through the 1950s and early 1960s, President of the Ontario Camping Association 1949-51 and of the Canadian Camping Association 1953-55 — wrote an account of the camp's observances that the national magazine reprinted as his obituary tribute in 1983.^20 The **Voyageur-Lumberman ceremony** in it is not a competition but a tableau at sunset, with a spoken text:

> "**Let us pause for a moment, and viewing the truly beautiful shades of our Muskoka evening, let us this day drink deep of the beauty in lake and sky and stately pine. Let us cherish the deep friendships discovered at this spot; may they give deeper meaning to lives already dedicated to helpful, purposeful ends.**"
>
> "There was a pause, and then you saw the **lumberman… clad in high boots, mackinaw shirt, and peak cap. With an axe on his capable shoulders he strode quietly along the shoreline to take his place against a giant pine… silhouetted in the sunset.** '**It is the Lumberman… craftsman, pioneer, conservationist… he is a living symbol of Canada's great forest lands. He is, too, an integral part of the lore and tradition of this place we call our camp.**'
>
> Another pause, and then **a canoe skimmed into silhouette. The paddler in buckskin coat and tasselled toque, skillfully set his craft ashore, and took his place opposite the Lumberman.** '**It is the Voyageur… explorer, adventurer, master of his craft, he looks to new horizons… for he, too, is Canada… and in this beautiful setting he travels with the greatest Sternsman of all time.**'"

Two things follow, and the limits of both should be stated. It shows that at Pine Crest the Lumberman and the Voyageur were **a ceremony with a liturgy before or beside being competition teams** — the axe and the canoe staged as figures, each given a speech identifying him with Canada — which is a different kind of thing from a week of races and mural-painting. And it gives, for the first time, **a text against which any surviving Kanawana ceremony, script or programme of the same name could be compared.**

**Nothing here mentions Kanawana, and no claim is made that Kanawana used this text or anything resembling it.** Yard directed Pine Crest in the 1950s, after Kanawana's borrowing of 1947, and his article is undated; the ceremony he describes may postdate what Kanawana took, or may be the older thing Kanawana took a competition out of. What can be said is that the two camps' shared vocabulary — Lumberman with the axe, Voyageur with the paddle, both cast as figures of Canada — was, at the source camp, ceremonial language. Whether Kanawana ever spoke anything like it is unknown, and finding out would mean a script or an order of ceremony in the Concordia fonds.

Yard's article also describes three other Pine Crest observances worth having as comparators: a sunset sharing circle in which "over a hundred children" rose one by one to say "**I remember…**"; a campfire induction in which inductees accepted the Pine as a symbol of **Strength and Fortitude**, **Personal Growth** and **Purity**, each with its own spoken formula; and a widening-circles ceremony in which a boy dropped a stone in the lake and campers rose in turn — "**our widening friendship circles take us to Poland, my homeland**", then Holland, Greece, Estonia, Scotland and Australia — which is a postwar YMCA camp making its immigrant intake into programme.
...
| 1966 | "Lumberman and Voyageur" (no unit word)^10 |
...
The tradition was not unique to Pine Crest and Kanawana, though the parallel is looser than an earlier version of this article stated (see Revision History). YMCA Hayo-Went-Ha Camps in Michigan (founded 1904) use "Woodsmen" and "Voyageurs" as program names, but direct fetches of both program pages show these are age-based program *levels* (Woodsmen: younger boys' general in-camp activities; Voyageurs: older campers' canoe-expedition tier, e.g. an AuSable River trip), not a Color-War-style competing team pair — neither page describes any team rivalry or scoring against the other.^5 ^9 The naming echo is real but is not evidence of a shared *competitive* tradition.

Camp Pine Crest's own camping lineage traces further back than 1940: it had roots in the Broadview Boys' Institute camping tradition dating to 1896; the Institute (Toronto) amalgamated with the Toronto YMCA in 1910 to become the Broadview YMCA, which opened Pine Crest that same year. However, the Pine Crest Games themselves are independently confirmed (YMCA of Greater Toronto's own history page and blog) to have begun only in 1940^3 — seven years before Kanawana adopted the format — so the 1896 root is camp/institutional lineage, not evidence the L&V-style competition itself is older than 1940.

More broadly, the general team-competition-week genre (of which Lumbermen-vs-Voyageurs is a Canadian/YMCA/frontier-themed regional variant) is documented by historian Leslie Paris (UBC) as originating with "Red and Gray Week" in 1916 at Schroon Lake Camp, a Jewish boys' camp in the Adirondacks, becoming a widespread American camp staple (known generically as "Color War") by the 1920s.^7 This places Kanawana and Pine Crest's L&V tradition as a regional YMCA branch of an already-established American genre, not a novel invention.
...
| **1961** | **Voyageurs** *— attributed, not read; see below* | | 1988 | Voyageurs | | 2015 | Lumbermen |
...
**Standings, all 79 seasons: Lumbermen 41, Voyageurs 38.** Across seventy-nine years the two teams are within three wins of each other. Thirty-eight of the Voyageurs' wins include the attributed 1961; on the trophy alone the read shields stand at **41–37**.

⚠️ **One entry rests on an attribution rather than the trophy.** 1961 is entered as a Voyageur win by operator instruction. If that shield is ever read and says Lumbermen, the standings become **42–37** and every figure derived from the roll — the running balance, the longest runs, the levelling arithmetic — shifts by one the other way. Nothing else in the table depends on judgement.

**The longest run on the trophy is five seasons: the Voyageurs, 1959–1963** — and it exists only because of the 1961 attribution, which is the single thing that joins the 1959–60 pair to the 1962–63 pair. Below that, four straight is the ceiling and it has happened four times — Lumbermen 1968–1971 and 1975–1978, Voyageurs 1979–1982 and 1992–1995. The 1975–1982 stretch is the most striking sequence on the trophy: four straight Lumberman years (the singular-spelled ones) answered immediately by four straight Voyageur years.

### The balance of the series

The near-even final tally conceals a series that has swung considerably. Running margins below are given from the Lumbermen's side — positive means they lead — and use the roll as it now stands, with 1961 attributed to the Voyageurs.

| Point | Margin | |
|---|---|---|
| 1948 | −2 | Voyageurs' early lead |
| 1963 | **−3** | the Voyageurs' high-water mark |
| 1978 | **+6** | the Lumbermen's high-water mark |
| 1995 | +1 | |
| 1998 | **0** | level |
| 2009 | +3 | |
| 2020 | **0** | level |
| 2026 | **+3** | where it stands |

The Lumbermen built a commanding lead through the first three decades, peaking in 1978 after winning 19 of the first 31 seasons. The Voyageurs then mounted their great recovery, **taking 11 of 17 seasons between 1979 and 1995**, and the series has been close ever since — until the Lumbermen pulled clear again with three straight from 2022 plus 2026.

On this reading **the series has been level thirteen times, most recently after the remote 2020 Games**, and the Voyageurs genuinely led it for a stretch of the 1960s, reaching −3 in 1963.

*Every margin from 1961 onward moves by one if that shield is ever read and contradicts the attribution: the Voyageurs' 1963 peak becomes −1 rather than −3, the series would not have been level since 1964, and the Voyageurs would never have led by more than two. The shape of the series does not change; its drama does.*

*An earlier version of this section gave a single set of running totals and stated that the Voyageurs "have led the all-time series only in its first two seasons." That was an artifact of omitting 1961 from the running count rather than carrying it; the claim is wrong under either reading and has been replaced.*

### How the series could be levelled

The Lumbermen lead by **three** (41–38). Since each season moves the margin by one, the Voyageurs need three more wins than the Lumbermen to square it — fastest achieved by winning every season from 2027, which would tie the series at **41–41 in 2029**. That is well within precedent: they have twice won four in a row, and on the current roll they once won five.

*If 1961 is ever read as a Lumbermen year, the lead is five and the earliest possible tie moves to **2031** — which would require the longest winning run by either team in the history of the Games.*
...
Two other parts of the same recollection *are* independently confirmed by the read shields, which is why the attribution is treated as well-founded rather than arbitrary: that the Lumbermen hold slightly more wins overall (41–37 on the read shields alone), and that the gap narrowed markedly during the early-to-mid 1990s.

In the 1991–1998 window the Voyageurs took six of eight seasons, pulling the series from +6 to +1 — the sharpest sustained swing anywhere in the record, and one witnessed first-hand. The trend has since reversed rather than continued: the margin has widened back to +3 in the years since.
...
8. *Kept as a caution, and deliberately uncited.* YMCA Quebec, "Voyageurs" canoe-tripping program page [src_ymcaquebec_voyageurs_page] — the camp's **present-day** Voyageurs, which is a canoe-tripping section and not a Games team. It is listed so that a reader meeting the word on the camp's own site does not read it back into the Games; nothing in this article rests on it. The same trap in reverse is the Hayo-Went-Ha naming echo at note 5.
...
- ~~**[New 2026-08-14, CRITICAL] The season reports contradict the trophy at 1966.**~~ **[Resolved 2026-08-14 by operator decision — the Lumbermen won.]** The *Kamp Kanawana Annual Report 1966* records "Lumberman and Voyage[ur], **with the Voyageurs being victorious**";^14 the trophy shield reads **Lumbermen**, and the shield is legible in the photograph.^18 Conflict `c_025` is closed in favour of the trophy; the report's text is preserved rather than corrected away. **What is still open is *why* they differ** — in particular whether the report and the trophy record different things, given that the 1966 report lists sixteen all-camp program days. When this line was first added it claimed the report was "matching the trophy shield." It does not match; that sentence was written without checking it against the roll two screens above, and it was false.
...
- **[Searched and exhausted 2026-08-14] The season reports cannot corroborate the roll any further — four years is the ceiling.** A dedicated pass read every surviving Kanawana season report (1964, 1965, 1966, 1969, 1970, 1971, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1987), the *Green Triangle* and *Ka-News* runs, the *Gas Bag*, the 1988 report and the SGW annual reports 1856–2009, searching for "lumber\*" and "voyageur" both with and without a win verb.^15 ^16
  **The corpus states a winner for exactly four seasons: 1966, 1977, 1978 and 1993** — all four already recorded above. The Games are *mentioned* in 1949/50, 1960, 1969, 1975, 1976, 1982, 1987 and 1988 **without naming a winner.** The reports consistently record that the event happened and not who won it, which is itself a small fact about what the camp thought worth writing down.
  This overturns a hope stated in this very article earlier the same day — that "up to seventeen further seasons of the roll may be independently confirmable." They are not. **Neither c_025 nor the 1961 shield could be settled from these documents**; both needed the physical trophy. c_025 has since been settled that way — from the trophy photograph — and 1961 is the one remaining case. On 1961 specifically: the 1961 SGW report covers the Kanawana season but drops the "Lumberman-Voyageur Day" phrase the 1960 report had used and reports no result, and the 1962 report carries no Kanawana programme narrative at all.
...
- ~~How many other YMCA camps adopted the Lumbermen/Woodsmen-vs-Voyageurs format? Was there a common source (e.g., a YMCA programming manual) or did it spread camp-to-camp?~~ [Reframed 2026-07-09] Hayo-Went-Ha's "Woodsmen"/"Voyageurs" turned out to be program-level names, not a competing team format (see Revision History) — so it is not actually a second example of the L&V-style team competition. The broader "Color War" genre (1916, Schroon Lake Camp, Adirondacks) is the real common ancestor of this kind of tradition; no evidence of a shared YMCA-specific programming manual was found.
...
<!-- R3 VERIFY: 1947 origin independently confirmed by YMCA Quebec official history (78th edition in 2025). Pine Crest inspiration independently confirmed by YMCA Quebec ("inspired by Pinecrest Camp") and corroborated by YMCA GTA blog documenting identical tradition since 1940. Team names, symbols (axe/paddle), and competition format match across both camps. Specific details (Friday team selection, model paddles/axes worn around necks, 1950 dining hall mural, war canoe races) are single-sourced from McMorris citing P145 season reports. -->
