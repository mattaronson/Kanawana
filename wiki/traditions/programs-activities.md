...
*Last Updated: 2026-09-08 (the 1977 season's machinery: training paid by a workers' board, a named caterer, two doctors)*
...
**And "Planned Group Development" was being run on the staff a year before it was run on the campers.** The short version of the 1959 annual report, under the heading "Another Significant Social Study," records that "**Kamp Kanawana in 1959 was the centre of a unique social study project**… an outgrowth of the **staff training retreat** earlier in the year. The Camp Committee studied and approved a proposed program of '**Planned Group Development**' **for camp counsellor and staff training in the 1959 season**."^nb59 Its aim was to raise "the level of '**Value Education**' in all camp program, first by increasing the skill of counsellors and staff to recognize '**Value Learning**' opportunities in the general program, and second, to be sensitive to symptoms of emotional or 'Value' problems in their young campers," and its finding was that "volunteer leaders, advisors, etc., given the proper setting and adequate skilled help, can achieve a high degree of competence **in leading a 'Value Education' program**."

**And the finding did not stay at the camp.** The sentence this article quoted for a day stopped where the passage had been read; the rest of it is the part that matters. "**Most important of all, the results encouraged branches to implement the new-type leader training sessions in their fall schedules.** These, too, have shown dramatic results on the **qualitative uplift of branch programs, and particularly youth club work**. **The new hypothesis of the decade had been proven.** With clear purposes, a meaningful set of values, and new education methods, an expansion is possible both in quantity and in quality."^nb59 So the association credits a summer's work at Kanawana with changing how its ten city branches trained leaders that autumn. This wiki carries a great deal about what YMCA doctrine did to the camp and very little running the other way; here is the association, in its own annual report, saying the camp was where a method was proved before the city took it up. The same report prints the nine **Values for Living** as a list — Healthy and Fit; Intelligent and Reasonable; Emotionally Healthy; Self-Reliant and Responsible; Socially Co-operative; Re-Creative; Motivated by Principle; Spiritually Vital; Aesthetically Appreciative — and records that Kanawana, Perrot and Otoreke together "benefited $75,000 in capital replacement and addition through the decade," against $4,740,000 spent across the association in the 1950s.^nb59
...
### 1977: what it took to run the place, in the director's own accounting

The 1977 director's report is the fullest single description this article has of a Kanawana season's machinery, as against its programme. Four of its sections are worth taking together.^kk77

**Training began in May, and a provincial insurer paid for part of it.** "Training of staff started early in May with **twenty-seven** of our program staff successfully completing the standard **St. John's Ambulance first-aid course**. This was **paid for by the Quebec Workmen's Compensation Board**." [f_5820] Beyond that the camp bought nineteen places across nine outside bodies: four at the Ontario Camping Association Conference and one at its Counsellors Workshop, six at the Quebec Camping Association Conference, one on a Canadian Yachting Association instructors course, two at the Canadian Recreational Canoeing Association Instructors School, one each at an Archery Instructors School, the National Woodsmanship School and the YMCA Aquatics Instruction School, and two visits to the **St. Hilaire Conservation Centre**. On top of that came an eight-day pre-camp programme and a **28-page staff manual** written over the previous winter by the twelve-person staff committee. Walsh credited the manual and the pre-camp week with much of the season's success. Two things stand out: a workers' compensation board underwriting first-aid certification for summer counsellors is a piece of the camp's operating economy recorded nowhere else here, and the camp sent more people to the **Ontario** association's events than to any body other than its own province's.

**The kitchen was catered, and the caterer is named.** This article already records the 1975 report saying the food was "catered for the first time"; the 1977 report says by whom. "Our food service was managed by **Bob Gill of Fan Fare Foods**", with **Jean-Claude Deglaire** as chef, and the arrangement followed a decision taken a year earlier: "I recommended that we **increase our food spending by 30%**. I now believe that in so doing a right decision was made." The parents' survey shows the effect in one year. Rated Excellent or Very Good, the food ran 34%, 42%, 23% and then **69.52%** across 1974 to 1977; rated Fair or Poor it ran 28%, 21%, 33% and then **7.02%**. A third of parents called the food excellent in 1977 against six per cent in 1976. [f_5823] The same two cautions apply as to the appraisal table at [[meta/attendance-series|the attendance series]]: the 1974-76 columns are whole numbers and 1977 carries two decimals, so they were not computed the same way, and the 1974 Excellent cell is printed "94" in the scan, which cannot stand against a column summing to 100 and is read here as 9%.

**Two doctors, a nurse and an assistant for about 250 people.** "Doctors **Sharon Levine (Section Director 1973)** and **Don Smith** were always available to treat all the aches, pains, scrapes, etc. of our **250 or so people at Kamp**", with **Melanie Moynan** as nurse "coping with the general running of the hospital" and Kate Schissler as her assistant. Colds and sore throats fell against 1976; two campers were sent home after accidents and two through illness, and two staff were hospitalised in Montreal, one for appendicitis. Walsh credited the improvement to **disposable dishes in the kitchen** and recommended them for both sites the following year. [f_5822] Sharon Levine is the detail worth keeping: a section director in 1973 back four years later as the camp's doctor, which is the camper-to-staff progression this wiki traces on the dining-hall plaques, carried a rung further into a profession.

**And five operating decisions the report asks to keep.** Buses were hired from the Laurentians rather than Montreal, which was cheaper and bought a **three-hour break at camp between groups**; the staff manual's **revised policy on cigarettes, for campers as well as staff**, was "well accepted by parents and Kanawantans alike"; **health food and fruit juices** were introduced in the Business Office; the non-refundable registration deposit was to rise sharply after **108 camper weeks of cancellations since 1 June**; and all canoes and rowboats were to be replaced with low-maintenance ones, "ie aluminum or whatever", over five to ten years. [f_5827] A sixth item is about communication rather than operations, and points at a document that would be findable if it exists: with two sites coming, "perhaps **a bulletin** explaining the physical and program changes should be widely circulated."
...
**The same year the camp went the other way as well, and built a step below its youngest section.** The 1998 report's year-in-review says "Kamp Kanawana **added a new activity to its summer program by offering camp initiation stays to younger children**."^ar98 Whether that is Kanawana-Be under another description, a shorter format inside it, or a separate offering, the report does not say — it calls it new, a year after Kanawana-Be launched, which is a small puzzle rather than a contradiction. What it does establish is that the camp was working on its bottom age boundary in two consecutive years. [f_5767]
...
- **kk77** — *Kamp Kanawana Director's Report 1977* [src_ia_kanawana_report_1977], its STAFF TRAINING, HEALTH & SAFETY, FOOD SERVICES and SPECIFIC RECOMMENDATIONS sections. Cached at `sources/cache/ymca-montreal-fonds/1977-kamp-kanawana-directors-report.txt`; read 2026-09-08 under p_441, working the document's own heading list. See [f_5820], [f_5822], [f_5823] and [f_5827].
