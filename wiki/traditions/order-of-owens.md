...
Years with two names denote two recipients in the same season.

| Year | Recipient(s) |
|------|--------------|
| 1976 | Doug Peets |
| 1977 | Denys Lawrence |
| 1978 | Graham Scammells |
| 1979 | Noelle Buck |
| 1980 | Amy Pearce |
| 1981 | Veronique Marin |
| 1982 | Jean Perron |
| 1983 | Gill Watt |
| 1984 | Miriam Schleifer & Eric Boghen |
| 1985 | Gesa Mahnke |
| 1986 | Eyal Artzy |
| 1987 | Mike Zeltzer |
| 1988 | Aaron Chase |
| 1989 | Siobhan Wallace |
| 1990 | Shawna Silver |
| 1991 | Simon Beauchemin |
| 1992 | Susan Owen |
| 1993 | Ryan Harbinson |
| 1994 | Charles Leduc |
| 1995 | Louis Lessard |
| 1996 | Catherine Lalonde & Véronique Fraser |
| 1997 | François Goulet-Lessard |
| 1998 | Matthew Wiviott & Randall Blom |
| 1999 | Theo Lerikos |
| 2000 | Mitchell McLarnon |
| 2001 | Megan Robinson |
| 2002 | Ian Braide |
| 2003 | Julian Dobie |
| 2004 | Alex Williams Zanis & Vienna Napier |
| 2005 | Thomas Gilbert |
| 2006 | Mike Romano |
| 2007 | Meyland Gravel-Labelle |
| 2008 | Oskar Newsam |
| 2009 | Russel Donahue |
| 2010 | Dylan Applebaum |
| 2011 | Michael Sklivas |
| 2012 | Emily Fleisler & Scott Bennet |
| 2013 | Rosie Kaye |
| 2014 | Pauline Morasse |
| 2015 | Theo King |
| 2016 | Owen Friesen |
| 2017 | Louis Friedland-Yust |
| 2018 | Ulysse Allard |
| 2019 | Sophie Parent |
| 2020 | *Not awarded — COVID-19* |
| 2021 | *Not awarded — COVID-19* |
| 2022 | Miriam Vandervort Charboneau |
| 2023 | Simon MacLaren |
| 2024 | Margot Simonian |
| 2025 | Laurent Thuot |
| 2026 | Charlie MacLaren |
...
<!-- Provenance: this article was created 2026-08-14 from a roster supplied directly by the operator in session. No web research was conducted; the Order of Owens had zero prior mentions anywhere in this wiki, kb/facts.json, or sources/sources.json before this entry. Recorded at confidence `user_knowledge` per the fact schema, since the operator is the stated source. See Open Question 3 -- the roster's internal precision suggests it was transcribed from a plaque or camp record, which if confirmed would warrant re-sourcing to that artifact at a higher reliability.

     INTERPRETIVE DECISION, flagged rather than made silently: the source list's first line is "April 13, 1976 - Norrey Owens", followed by "1976 - Doug Peets". Rather than record two 1976 recipients, this article reads Norrey Owens as the award's namesake (matching the award's name; carrying a full date where all other entries carry a year only) and Doug Peets as the first recipient. That is inference. If the operator confirms Norrey Owens was in fact the first recipient, the Namesake section and Open Questions 1-2 need rewriting and the recipient count changes from 54 to 55.

     PRIVACY NOTE: unlike the Pip Alumni Award -- whose recipients are largely public figures honoured for post-camp achievement -- the Order of Owens goes to members of the camp community for conduct at camp, so most of the 54 named people were campers or junior staff, many of them minors at the time, and several of the recent recipients may still be. Publishing an award roster is consistent with existing practice here (the Pip recipients table and the CIT/section rosters in people/directors-index.md), and the operator supplied this list explicitly for publication, so it is published in full. Three names nonetheless warrant the operator's attention rather than a silent decision: Jean Perron (1982) and Louis Lessard (1995) both appear on the formerly-C5 privacy list whose scope is still open in queue item p_221; and Ian Braide (2002) is one of the two private individuals whose family detail was deliberately REMOVED from people/notable-alumni/rob-braide.md on 2026-08-12 under CLAUDE.md's Phase 2 rule. Naming him as an award recipient is a materially different and much narrower claim than the genealogy that was removed -- an institutional camp record versus asserted parentage -- so the two decisions are consistent, but the overlap is noted here deliberately so it is not mistaken for an oversight.

     CORROBORATION FOUND: the roster's "2020-2021: Not Awarded (COVID-19 years)" independently confirms, from a camp-internal record, that Kanawana's overnight camp was closed for BOTH the 2020 and 2021 seasons -- matching sean-day.md:44 and the underlying CBC-sourced KB facts. This is directly relevant to queue item p_222, which tracks the correction of history/modern-era.md:16 ("closed overnight in 2021 ... then reopened in 2021"), a self-contradictory claim the p_218 VERIFY sweep flagged as the single most consequential defect in that cluster. This roster is now a second, independent line of evidence for that fix. -->
