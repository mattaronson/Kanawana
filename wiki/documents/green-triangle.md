...
A 2026-07 direct query of the Internet Archive's advanced-search API confirmed that 38 issues spanning the newsletter's full 1932–1982 run, uploaded by Concordia's Records Management & Archives, are actually digitized and searchable online — significantly expanding the pool of primary-source camp-newsletter material available for research, beyond the single July 29, 1938 issue previously known to be digitized.^4
...
1. Concordia Archives — YMCA of Montreal Fonds P145 [src_concordia_fonds].
2. "A History of Kamp Kanawana" (1935 Season Chronicle) [src_history_1935].
3. Concordia University Archives, YMCA of Montreal Fonds, Sub-sub-series 12B04 (Finding Aid page) [src_concordia_ymca_fonds_12B04_finding_aid].
4. The Green Triangle — full digitized run, 1932–1982 (38 issues, Internet Archive) [src_ia_green_triangle_collection].
5. The Green Triangle, July 29, 1938 [src_green_triangle_1938].
6. The Green Triangle, July 8, 1933 [src_green_triangle_1933_07_08].
7. Buckland, Smillie. "How Summer Camp Shapes Lives." Reader's Digest Canada [src_readers_digest_camp_shapes_lives].
