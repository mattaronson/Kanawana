...
The age range continued to creep downward through the 1930s. By the early 1940s, the youngest campers had their own section: Bantams, initially covering ages 8 to 10. This brought the total to four sections, roughly dividing the camp population into two-year age bands from 8 through 17. The names at this stage were functional rather than evocative. Bantam, Juvenile, Junior, Senior. They told you where a boy stood in the camp hierarchy and nothing more.
...
The 1959 names survived. More than six decades later, all four are still in use at the camp, though the age ranges and organizational logic have shifted considerably. Where the original system sorted boys by age into two-year bands, the current structure uses the same names to organize campers by gender identity and program type. Pioneers encompasses girls and non-binary campers aged 7 to 12, while Woodsmen covers boys and non-binary campers in the same age range. These two make up the Junior sections. In the Senior sections, Coureurs de Bois serves boys and non-binary campers aged 13 to 16, while Pathfinders covers girls and non-binary campers of the same age. The camp has also added newer section names not derived from the 1959 system, including Voyageurs, Rangers, Trailblazers, Foresters, Adventurers, Explorers, and Senior Kanawanians, reflecting the expansion to co-ed programming and specialized trip programs.
...
YMCA Quebec website (checked Feb 2026) confirms: Pioneers and Woodsmen are Junior sections (cabins); Coureurs de Bois and Pathfinders are Senior sections (platform tents). Gender split: Pioneers/Pathfinders = girls and non-binary; Woodsmen/Coureurs de Bois = boys and non-binary. Additional sections confirmed: Rangers, Trailblazers, Voyageurs, Senior Kanawanians, Foresters, Adventurers, Explorers.
