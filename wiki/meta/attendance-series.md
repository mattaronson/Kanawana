...
*Status: draft | Sources: 52*
*Last Updated: 2026-09-07 (four more Social Audit years, out of the French editions)*

## Overview

This article assembles every camper count and camper-week figure the project has located, from the first camp of 23 boys in 1894 to 780 in 2023. Roughly sixty seasons are covered across 130 years. Nearly all of it comes from one seam: the YMCA of Montreal's annual reports, read in full in August 2026.^1
...
Two camps ran in parallel on one leased lake: the Junior Department's boys' camp — which becomes Kanawana — and a senior/members' camp, which stays and becomes [[site/camp-otoreke|Camp Otoreke]].^2

| Season | Boys | Senior members | Notes |
|---|---|---|---|
| **1894** | **23** | 53 | "our first Summer Camp… composed of 23 workers and boys" |
...
| 1931 | 356 | 1,148 | |
| 1932 | 360 or 385 ⚠️ | 1,164 | Both wells ran dry |
| 1933 | 287 | 1,078 | Nine weeks instead of ten |
| 1934 | 232 | 1,017 or 972 ⚠️ | |
| 1935 | 259 | 917 | |
| 1936 | 310 | 1,092 | |
...
| 1941 | 322 | 1,266 | |
| 1942 | 319 | 1,330 | |
| 1943 | 368 | 1,343 | Wartime guests from England, Scotland, France, Poland |
| 1944 | 400 | 1,450 | Skiers used the camp that winter |
| 1945 | 324 | 1,360 | |
| 1946 | 302 | 1,150 | Polio year — see the note below |
| 1947 | 320 | 1,394 | |
...
**The camp roughly doubled twice.** From about 20–25 boys through the 1890s, to 160–190 in the 1910s, to 270–400 in the 1920s, to 500+ by the late 1930s. The 1939 season (526 campers, 1,477 boy-weeks) is the pre-war peak and was not exceeded until the mid-1950s.

**The Second World War did not shrink it.** Boy-weeks run 1,438 / 1,266 / 1,330 / 1,343 / 1,450 / 1,360 across 1940–45 — flat to slightly up, against a backdrop of staff leaving for war service. The camp's own reports insist on this ("The season of 1915 was highly successful notwithstanding the war"), and for once the numbers agree with the rhetoric.
...
- [[history/founding-1894|Founding and Early History]]
...
<!-- Created 2026-08-14 (p_256) from the 114-annual-report sweep. No new research for this spawn.
     WHY THIS IS A SEPARATE ARTICLE rather than a table bolted onto timeline-overview.md: that page is a hub with no sources of its own, and adding sixty rows of primary-sourced data with six flagged contradictions would have changed what it is. More importantly, the contradictions need to travel WITH the numbers. A reader who takes "1,017 boy-weeks in 1934" out of a prose sentence elsewhere in the wiki has no way to know the 1936 report says 972.
     The six flags are the point of the article as much as the data is. Every one of them is the association contradicting itself, not a transcription problem on this project's side -- which is worth saying, because the instinct with a dataset is to pick the likelier figure and move on.
     DELIBERATELY NOT DONE: no attempt to compute a lifetime total or a decade-average from these figures. The series has too many missing years, the 1998-2001 rows count a different population, and the two documented lifetime totals (40,000 in 1964, 34,000 in 1984) contradict each other and the series. Any aggregate would be false precision.
     Status "stub"/"draft": marked draft because it has a summary, multiple substantive sections, five sources and a full open-questions list, and because its content is transcription of primary figures rather than synthesis -- the failure mode p_218 found (synthesis drift) does not apply the same way to a table of quoted numbers. It has NOT had a VERIFY pass; the figures should be spot-checked against the OCR before it advances further. -->
