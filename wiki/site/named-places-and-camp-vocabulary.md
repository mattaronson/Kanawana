...
A camp accumulates its own words. Buildings, tents, portages and programs acquire names that everyone on site understands and no outsider would recognise, and most of them are never written down anywhere but on the wall of a dining hall. The [[meta/plaque-audit|plaque audit]] of August 2026 read all 151 surviving boards and turned up a vocabulary this wiki did not hold — place-names with no entry in the site record, abbreviations used as though self-evident, and one word that took an operator's correction to read properly.^1

This article collects them. Several are single attestations and are flagged as such.
...
**Trip destinations named on the boards** — useful because they establish where Kanawana actually paddled in given years: Lac des Sept Frères, Lac Montjoie, Lac Bruchési and Lac Saint-Denis (the mapped 1982 route); Taureau Reservoir (1973); La Vérendrye, which the boards abbreviate to **LAV**; **Papineau-Labelle**, abbreviated **PAP** and appearing as "PAP-5" for a five-day trip; the Rivière Rouge (2007); the Missinaibi (2008); and the Ashuapmushuan, north-west of Lac Saint-Jean, the furthest destination named anywhere in the collection.^1

## Abbreviations the boards use without explaining

The 1998 swim board tags each swimmer with a section code — **SB, JG, B, SGC** — running down its right edge, and the codes recur elsewhere.^1 Read against boards that spell their sections out, they resolve as **Senior Boys**, **Junior Girls**, **Bella** (a Senior Girls tent) and **Senior Girls Cabin**, the last confirmed by a 2007 board that prints "SGC" beside a roster it also labels Senior Girls. **JBC** is Junior Boys' Camp. **C. de B.** is Coureurs de Bois. **S.D.** is Section Director. These matter because a board carrying only codes can now be read.
...
- The **Pathfinder Section** paddle carries, beside its roster, a column of **origins**: Australia, England, Holland, Cape Breton, France, Virginia. The names themselves are abraded past reading; the origins are perfectly legible.^1 **It is almost certainly from 1964.** The camp's annual report for that year says that "in one section alone six different countries were represented on the staff, one from Holland, one from Poland, three from England, one from France, one from Australia and of course from Canada," and separately that staff came "from as far east in Canada as Cape Breton Island to Toronto in the west and as far south as Virginia in the United States." Five of the paddle's six origins are in the first sentence and the remaining two Canadian and American ones in the second. Stanley Wasilewski was Pathfinder section director in 1964, his fifth year in the post.^7
...
- The Basin boards of 2007–08 carry a Spanish-speaking contingent (Lorena Sanchez, Yaisa Lopez, Maria and Sofia Pardo, the tent name "Burbujas"), and the 2008 Adventurer Boys board is signed with nationality nicknames — "Russia," "Viva Italia!", "Yankee."^1

None of this dates the practice, and the Pathfinder paddle carries no year at all despite its filename. But it establishes that international presence at Kanawana is older and better attested than the current program pages alone would suggest.
...
- [[traditions/knights-of-kanawana|The Order of the Knights of Kanawana]]
...
<!-- p_296. Every place-name and code here comes from a photograph this project has held for years; nothing was researched outward. The "Wolf" section is kept as a correction rather than quietly rewritten because the mistake is instructive: an unfamiliar word in a list of familiar job titles read as another job title, when two boards already transcribed in the same audit showed programme names being credited the same way. -->
