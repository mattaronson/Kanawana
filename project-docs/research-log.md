...
This log records each Phase 2 search campaign: topic, queries tried, surfaces searched, results.

---

## Campaign 1: People — Biographical Research

### Target: Billy Ball (founding director 1894)
**Date:** 2026-03-15
**Status:** EXHAUSTED (online sources)
**Queries tried (25+):**
- "William Ball" YMCA Montreal → null
- "Billy Ball" YMCA Montreal → only existing KB sources
- "Billy Ball" camp 1894 Quebec → null
- "William Ball" Montreal obituary → null
- "Ball" YMCA Montreal Boys Work → null
- "William Ball" Montreal 1890s → null
- "Billy Ball" camp counsellor Montreal → null
- "Ball" YMCA camp Quebec 1894 → null
- "William Ball" Montreal genealogy Find A Grave → null
- "Ball" Montreal YMCA annual report 1894 → null
- FamilySearch William Ball Montreal 1860-1880 → null
- Google Books "Billy Ball" YMCA → null
- HathiTrust "Billy Ball" camp → null
- Various additional combinations → null

**Results:** Zero new biographical information. Billy Ball remains completely undocumented online. The only attested form of his name is "Billy." No birth/death dates, no YMCA title, no obituary, no genealogical records.
**Archival leads:** Concordia P0145/12L (camp scrapbook 1880-1910, Camp Jubilee letter 1895); BAnQ Lovell's Montreal directories 1890-1910 (search for "Ball, William").

### Target: Harold C. Cross (Boys' Work director)
**Date:** 2026-03-15
**Status:** EXHAUSTED (online sources, confirmed Phase 1 finding)
**Queries tried:**
- "Harold C. Cross" YMCA Montreal Boys Work director obituary → null
- Legacy.com Harold Cross → unrelated individuals only
- Various combinations → null

**Results:** No new information. Cross remains documented only through Concordia archives references.

### Target: Directors 1947-2003 gap
**Date:** 2026-03-15
**Status:** PARTIAL PROGRESS — 4 new names identified
**Queries tried (22+):**
- "Camp Kanawana" director 1950s/1960s/1970s → archival references only
- "Brian Langille" Kanawana → null
- "Dave Twynam" YMCA Kanawana → confirmed via LinkedIn as VIU Dean
- "David Twynam" camping outdoor education → academic career documented
- "Camp Kanawana" 1994 centennial → null
- site:linkedin.com "Camp Kanawana" director → David Leduc found
- Stuart McLean Kanawana director (who was boss) → anonymous Westmount Mag commenter
- Various combinations

**New names found:**
1. **Dave Twynam** — Camp director 1979 (Concordia archives). Later G. David Twynam, Dean of Faculty of Management at VIU, recreation/tourism academic. HIGH confidence.
2. **Ross Bannerman** — Authored "Report on Kamp Kanawana" 1969 (Concordia archives). Possible director. MEDIUM confidence.
3. **Anonymous director 1974-75** — Commented on Westmount Magazine McLean tribute, identified self as camp director while McLean was assistant director. Name not visible (page 403).
4. **David Leduc** — LinkedIn: managed all Kanawana summer/winter programs (75 employees, 800 participants). Dates unknown.
5. **Sean Day** — Confirmed as "former director" post-2022.
6. **E.E. Smee** — "Resident Director" in 1942, alongside Camp Director R.H. Hanagan.

**Remaining gaps:** 1947-1968 (21 years), 1970-1973, 1981-2003 (22 years).

### Target: Cushing family disambiguation
**Date:** 2026-03-15
**Status:** ADVANCED — key genealogical facts established
**Queries tried:**
- "Cushing" family Montreal genealogy 1870s sons Lemuel → DCB, Wikipedia, Geni profiles
- "W.E. Cushing" OR "Walter Edgar Cushing" Montreal YMCA → null
- "Harold Beveridge Cushing" Montreal physician → null
- Cushing genealogy Montreal 1905 James Cushing → 1905 genealogy identified
- site:geni.com Cushing Montreal Lemuel children → family tree outlined

**Key findings:**
- Lemuel Cushing Jr. (1842-1881) was YMCA Montreal president 1869-70 — died 11 years before 1892 trip
- Lemuel Sr. (1806-1875) had 8 sons including Thomas (Montreal Brewing), James Brock (Colonel), Charles (notary), Francis (hired Olmsted), Frederick (b.1851), William Mair (d.1925)
- James Stevenson Cushing (1878-1957) authored 1905 genealogy update — likely son/nephew of Lemuel Jr.
- The "1892 Lemuel Cushing" MUST be a third-generation Cushing
- Full 1905 Cushing genealogy on Internet Archive (proxy-blocked) would resolve this definitively

### Target: Pagé family (land sellers)
**Date:** 2026-03-15
**Status:** ADVANCED
**Queries tried:**
- "Pagé" OR "Page" farm Saint-Sauveur YMCA 1910 → YMCA website confirms acquisition
- "Domaine Pagé" Saint-Sauveur Quebec history famille → Boulangerie Pagé, Domaine-Pagé locality
- "Boulangerie Pagé" Saint-Sauveur 1903 → full history obtained

**Key findings:**
- Pagé family deeply rooted in Saint-Sauveur since at least 1903 (Boulangerie Pagé)
- "Domaine-Pagé" is a named locality in Saint-Sauveur — near camp site
- Georges Pagé purchased a farm from a relative in 1951
- The "Page family" who sold land to YMCA is almost certainly this Pagé family

---

## Campaign 2: Cultural Elements

### Target: Songs and cheers
**Date:** 2026-03-15
**Status:** EXHAUSTED (online sources)
**Queries tried (20+):**
- "Richard Kerr" YMCA camp song composer → null (only Barry Manilow songwriter)
- "Richard Kerr" "On My Way to Kanawana" → null
- YMCA camp song book Internet Archive → 1904 Hymn Book, 1938 Camp Songs Books
- "Alabama Jubilee" camp song adaptation → confirmed existing knowledge
- site:archive.org "YMCA" "camp songs" → null for Kanawana-specific
- Camp Sloane YMCA cheers → section cheer tradition documented
- IMSLP YMCA camp songs → 1904 Association Hymn Book only
- Library of Congress camp song collections → Cooperative Recreation Service collection
- Various combinations → null

**Results:** Richard Kerr (Kanawana) has zero web presence. Concordia CD P145/SR0001 remains sole known copy. Broader YMCA song tradition documented (1904 hymn book, 1938 Camp Songs Books, WWI Service Song Book). Camp Sloane confirms section cheer tradition parallel.

### Target: Chopsy legend
**Date:** 2026-03-15
**Status:** EXHAUSTED (online sources, confirmed Phase 1 finding)
**Queries tried (6+):**
- "Chopsy" camp ghost story → null
- "Chopsy" OR "Chopsey" OR "Chopsie" camp → null
- Quebec camp ghost stories legends → null for Chopsy
- Canadian summer camp ghost stories folklore → academic framework only

**Results:** Zero results in any spelling across any surface. Name does not appear in any folklore archive, academic database, blog, or camp story collection. Oral history is the only viable path.
...
**Results:** Motto derives from Cicero's De Officiis (1:22). Lower Canada College (founded 1909) shares the SAME motto — adopted from founder Fosbery's family crest. Whether Kanawana adopted it independently or through LCC connection is unknown. Key research question generated.

---

## Campaign 3: Inter-Camp and Institutional Connections

### Target: Camp Weredale
**Date:** 2026-03-15
**Status:** MAJOR DISCOVERY — sufficient for article stub
**Queries tried:**
- "Camp Weredale" YMCA Montreal history founded → batshawcentreshistory.ca
- "Camp Weredale" "Lac l'Achigan" → confirmed location
- "Weredale House" Montreal → Charles Alexander biography

**Key findings:**
- Camp Weredale was NOT a YMCA camp — owned by Weredale House (Boys' Home)
- Founded 1934 by Rotary Club of Westmount (260 acres, Lac l'Achigan)
- Weredale House founded 1870 by Charles Alexander (1816-1905)
- ~24 buildings including Indian Council ring, chapel, rifle range
- Earlier Camp Boy (1918) → Camp Lewis (1919) for Weredale boys
- Fire 1965, rebuilt. Weredale House → Youth Horizons 1977
- YMCA explored two-site Kanawana-Weredale plan 1977-1980
- Still operating under Weredale Foundation (co-ed, 6-17, 340 campers)
- LAC holds Weredale House fonds (1868-1975)

### Target: Camp Ouareau
**Date:** 2026-03-15
**Status:** KEY PERSONNEL LINK FOUND
**Key findings:**
- Founded 1922 by Mabel Jamieson and Ferna Halliday (all-girls camp)
- Mabel Jamieson was secretary general of YMCA of Montreal — direct personnel link to Kanawana
- Located Notre-Dame-de-la-Merci, Lac Ouareau
- YWCA Camp Oolahwan (1917) held centennial reunion there 2017

### Target: Canadian camping associations
**Date:** 2026-03-15
**Status:** KEY ARCHIVAL LEAD FOUND
**Key findings:**
- CCA founded May 20, 1936 at Central YMCA Toronto (Taylor Statten president, Mary Edgar VP)
- OCA archives at Trent University hold a KANAWANA FILE dated 1940
- Kanawana currently listed with Association des camps du Quebec
- YMCA Camp Waabanaki name change 2023 for Indigenous reconciliation

### Target: McGill/Concordia/LCC connections
**Date:** 2026-03-15
**Status:** LIMITED FINDINGS
- No LCC-Kanawana direct connection found (though shared motto is significant)
- No McGill Daily articles on Kanawana confirmed
- EMSB runs "Camp Kanawana Experience" sending students
- McGill Garage Band Camp performed concert at Kanawana (Facebook)

---

## Campaign 4: Newspaper Research — Expanded

**Date:** 2026-03-15
**Status:** 3 NEW ARTICLES FOUND
**Queries tried (24+):**
- Google News Archive "Camp Kanawana" → null (archive seems defunct)
- site:newspapers.com "Kanawana" → 7 total Gazette articles
- "Montreal Gazette" "Camp Kanawana" → confirmed hits
- Chronicling America LOC "Kanawana" → null
- Fulton History "Kanawana" → null
- HathiTrust "Camp Kanawana" → null
- BAnQ "Kanawana" → 403 blocked
- Various other → null

**New articles found (not previously known):**
1. **1933 (Feb 24)** — "Music and Comedy in Fossils' Revue" — alumni group called "the Fossils"
2. **1942 (Aug 5)** — "Y.M.C.A. Boys Stage Parade and Circus" — names Hanagan (in Indian garb) and E.E. Smee as Resident Director; Bantam/Junior/Intermediate/Senior sections
3. **1974 (Apr 18)** — "Summer Camps - Kanawana"

**Previously known articles confirmed:** 1897 (Jul 7), 1913 (Jul 7), 1918 (Jul 11), 1918 (Jul 27)

**Dead ends:** Chronicling America, Montreal Star, Montreal Standard, BAnQ numerique, Fulton History, HathiTrust, Google Books all returned zero results. Coverage concentrated almost entirely in Montreal Gazette.

---

## Campaign 5: Visual and Material Culture

**Date:** 2026-03-15
**Status:** ARCHITECTURE LEAD CONFIRMED; MEMORABILIA NULL

**Architecture:**
- CCA Ross & Macdonald Doctor's Cottage drawings confirmed (already known)
- In-person CCA visit needed for full details

**Film/Audio:**
- 1993 documentary by Cathy Reeves confirmed at Concordia (YouTube access copy noted)
- 1941 CFCF radio broadcast on Internet Archive confirmed (already known)

**Photography:**
- Flickr "Kanawana" account: 4,416 photos (not reviewed for historical content)
- Instagram @ymcakanawana: 571 posts

**Maps:**
- Camp Kanawana in Canadian Geographical Names Database (ID: EKWXQ)
- Bathymetric chart of Lac Kanawana available
- No historical property maps or topographic sheets found

**Memorabilia:**
- eBay/Etsy/WorthPoint: ZERO Camp Kanawana items
- One c1915 Valcartier YMCA Camp postcard on eBay (parallel tradition, not Kanawana)
- McCord Museum/LAC: nothing indexed under Kanawana

**Social media:**
- Facebook: 3,549 likes, 2,823 check-ins. No dedicated alumni group found (may be private)
- Reddit: zero threads on Camp Kanawana
- 120th anniversary reunion at Victoria Hall, September 5, 2014

---

## Campaign 6: Social Media and Alumni Networks

**Date:** 2026-03-15
**Status:** MINIMAL FINDINGS
**Results:** No Reddit threads. No public alumni Facebook group found. Instagram and TikTok are contemporary promotional. LinkedIn surfaced David Leduc and confirmed Sean Day as former director. No historical facts from social media sources.
...
| New facts added | 93 (f_0725-f_0855, minus original f_0724) |
| New sources added | 22 |
| New names identified | 6 (Twynam, Bannerman, Leduc, Day, Smee, Slezak) |
| New newspaper articles | 3 |
...
## Campaign: p_129 — YMCA Quebec organizational structure (2026-06-11)
...
## Campaign 22: Photo Archive Integration
*Date: 2026-07-02*
*Scope: Integrate the three ZIP archives Matt placed at `photodownloads/` (244 images, ~100 MB) into `assets/images/`, `credits.json`, and the wiki. Autonomous end-to-end run per `project-docs/NEXT-SESSION-PROMPT.md`.*

### Inventory and identification
Unzipped all three archives to a scratch working area (never committed). Identified three distinct sources by visual inspection of samples from each:
- **Archive 2** (34 images) is the existing `img_concordia_archives_album` placeholder in `credits.json` — genuine vintage photographs and site maps from the Kanawana Flickr "University Concordia Archives" album, 1900s-2001. Confirmed by inspection (kanawana_4, kanawana_6): real candid/staff photographs, not reproductions of anything else.
- **Archive 1** (151 images) is the existing `img_cit_plaques` placeholder — the Kanawana Flickr "Plaque" album. Visually inspected 5 samples across the filename space (cit-1960, staff-1933, western-day-1968, malibu-trip-2001, chopsy-2006) and confirmed **every image is a modern (c.2010) photograph of a physical hand-painted/carved plaque or canoe board** mounted in a camp building, naming a section/trip/year and its members or director — not a candid photo from the named year. This matters for copyright (see below) and for reading the content correctly (e.g. "staff-1933.jpg" is a 2010-era photo of a decorative crest referencing 1933, not an actual 1933 photograph).
- **Archive 3** (59 images) is Matt's own scans of physical camp memorabilia: honour-award ribbons (Aquatic/Athletic/Educational/Social Service Depts., c.1920), felt letter awards, a YMCA pennant, t-shirt/silkscreen art (1980s-90s), the 1913 reunion banquet menu, and two unusually rich finds — the 1981 "Knights of Kanawana" induction charter (artwork/lettering by Greg Shevchenko, May 1981, full oath text) and a handwritten "Medley '81" sheet of camp cheers/chants (verbatim lyrics for several chants, including a Voyageurs sound-off and a girls'-section cheer).

### Copyright classification — a bug caught and fixed mid-integration
Initial pass classified rights by the year embedded in each filename (e.g. "rangers-1955" → pre-1949? no, but "staff-1933" → treated as a 1933 photo → wrongly marked public domain). This is wrong for both the plaque album and the physical-artifact scans: **the operative date under the Canadian copyright rule is when the photograph itself was taken, not the date of the depicted subject.** All 151 plaque photos and all 59 artifact/art scans are modern (c.2010 and 2026 respectively) regardless of what year is painted on the plaque or how old the ribbon is. Corrected 28 credits.json entries + 10 wiki-article caption lines from "public domain" to "Copyright All rights reserved by Kanawana" before committing. Only genuine reproductions of pre-1949 originals (the 16 oldest Archive-2 images) keep public-domain status.

### Filing and KB additions
234 of 244 images filed to `assets/images/{historical,maps,plaques,artifacts,art}/`; 10 near-duplicate scans of the same physical item skipped (noted in `credits.json`/commit message). Added 2 new source records (`src_flickr_kanawana_plaque_album`, `src_flickr_kanawana_concordia_historical_album`, `src_kanawana_physical_archive_scans_2026`) and updated the stale `src_flickr_kanawana` placeholder. Added 4 new KB facts (f_1564-f_1567) from content read directly off the plaques/scans: the 1972 "Kanawana's First All Female Canoe Trip" board (9 named participants, "Power to the Women!"), the Knights of Kanawana roll board (1980-2009 by name), the full 1981 Knights induction oath text, and several verbatim 1981 cheer/chant lyrics. Tightened the existing f_1544 (Ron McCallum / 1960 CIT plaque) citation now that the actual image is cached.

### Article wiring
Wired a curated selection (not an exhaustive dump — the 151-photo plaque album alone would clutter every article) into 15 articles as new "## Images" sections: founding-1894, the-kanawana-site, places-and-locations, lake-wilson, directors-index, canoe-trips, traditions-and-culture, myths-and-legends, camp-songs-cheers, kanawana-in-media, section-names, coeducation-gender, programs-activities, environmental-history, winter-programming. ~40 distinct images embedded (some reused across 2 relevant articles); each with an alt tag, encyclopedic caption, and the correct rights/credit line.

### What's left unembedded
The remaining ~194 filed images (mostly the other ~140 plaques, spanning nearly every section/year/trip from 1955-2010) are acquired and credited in `credits.json` but not individually embedded in any article. **This is a large untapped primary source for director/counsellor names and section rosters by year** — flagged in `src_flickr_kanawana_plaque_album`'s notes for future KB-extraction work, distinct from today's image-filing task. 8 items from the original 12-target want-list in `PHOTO-ACQUISITION.md` remain `not_acquired` (flag-raising c.1910, camp truck c.1910, the 1898 Jubilee group photo, Otoreke items, McCord postcard, Harold Cross portrait, centennial poster, Facebook album) — none were present in this delivery.

## Campaign 23: Two-Tier Era Directors — Oral History Resolution + RALPH Verification
*Date: 2026-07-05*
*Scope: Resolve conflict c_014 (2003 camp directorship, flagged during Campaign 22's photo-mining VERIFY pass) and independently verify the resulting corrections and new names.*

### Oral history: the 1995 Executive/On-Site split
The operator (unprompted, in response to c_014) revealed that Camp Kanawana's directorship split into two parallel roles starting in 1995, after Bruce Netherwood's departure: a year-round **Executive Director** (Montreal-based, organization-wide) and a three-season **on-site Director**, colloquially "**Chief**" until the title — dating to the camp's "playing Indian" era — was retired in the early 2020s as part of reconciliation efforts. This single fact resolved c_014 cleanly: Morgan Carter's on-site tenure extends to 2001-2003 (not 2001-2002), and Dave Leduc's is a single summer, 2004 (not 2003). It also corrected/refined five other entries (Johanna A.A. Hoade for "Joanna Hode," Sean Day's role to Executive Director 2005-2023, Kate Taylor's tenure to 2013 through 3rd session 2023, Kevin Slezak's promotion to on-site Director for 4th session 2023-2024, Marie-Pierre Lacasse's start to spring 2023) and added three previously-undocumented names: Arlene Boyle, Gary White, Nicholas Garcia, plus current on-site Director Justin Caldwell. 12 new facts (f_1728-f_1739), all `src_oral_aronson` / `confidence: user_knowledge`. Rewrote directors-index.md with a new "Two-Tier Era (1995-present)" section (separate Executive Directors / On-Site Directors tables).

### RALPH verification pass (5 parallel agents, ~130 queries)
Per the Phase 2 exhaustion standard (8+ queries across 3+ surfaces), ran wide web research — general search, LinkedIn, Facebook, Instagram, news archives, YMCA Quebec's site, obituary/genealogy databases, French-language equivalents — on all four new names plus the six corrected dates.

**Queries and surfaces per target:**
- Arlene Boyle: 27 queries across web/LinkedIn/Facebook/obituary/genealogy — **zero corroboration, zero contradiction.**
- Johanna A.A. Hoade (+ "Joanna Hode" and spelling variants): 13+ queries including French-language — **zero corroboration.** Incidentally surfaced a previously-unflagged Concordia Spectrum thesis, "An Experience That Lasts a Lifetime: Building Modernity, Man, and Nation at the YMCA of Montreal's Kamp Kanawana, 1894-1967" — worth ingesting separately for the pre-1967 period (not yet actioned).
- Gary White: 22 queries — found an **ambiguous, unconfirmed lead**: a "Gary White" documented via an `allpeople.info` listing as Director of the Westmount YMCA *branch* (a different YMCA unit than the overnight camp), 2012-2018, plus a LinkedIn "YMCA Canada Membership Excellence Institute" association dated 2007-present. Neither confirmed as the same individual as a 2001-2005 Kanawana Executive Director — different role, different decade.
- Nicholas Garcia: 24 queries — **zero corroboration, zero contradiction.** One search-engine auto-summary asserted an unnamed "director of expeditions at Kanawana from 2007 to 2010" with no underlying source ever produced — explicitly discarded as an unsubstantiated AI-summarizer artifact, not treated as a fact.
- Justin Caldwell: 27 queries — **partially corroborated.** A July 25, 2018 Camp YMCA Kanawana Facebook video names "Tripper Justin Caldwell" introducing the Voyageurs canoe-trip program (f_1741) — independent proof of a genuine, camp-specific staff history, 7 years before the claimed directorship. Two independent commercial aggregators (ZoomInfo, Datanyze) separately list a "Justin Caldwell, Summer Camp Director at YMCA of Quebec" (f_1742) — consistent with the claim, but a direct LinkedIn search for the name/location did not surface a matching profile, so this is a lead, not primary-source confirmation.
- Date-correction verification (Carter, Leduc, Day, Taylor, Slezak, Lacasse): found strong independent corroboration for **Sean Day** (CBC News, Stuart McLean fund article: "Sean Day ... was director of Camp Kanawana" when McLean returned in 2005 — f_1740, upgrading the vaguer pre-existing f_0046 "was present"). Found a genuine **open nuance for Marie-Pierre Lacasse**: her LinkedIn title reads "Directeur principal" of the YMCA-Quebec organization *region-wide*, while French-language press (Journal Accès, Nouvelles Laurentides) calls her "directrice du Camp" — the two aren't obviously the same scope of role, and no source confirms the spring-2023 start date independently. Flagged as a new Open Question rather than escalated to a formal conflict, since it's ambiguous rather than a clean contradiction. Morgan Carter, Dave Leduc, Kate Taylor, and Kevin Slezak: general career facts/title existence corroborated in outline by existing or newly-found sources, but no independent source pins the exact corrected dates.

### Environment limitation (flag prominently)
WebFetch/direct curl returned **HTTP 403 on nearly every direct-page target** across all 5 agents this session: `ymcaquebec.org` (team and history pages), `linkedin.com` (all profile URLs), `facebook.com` (post/video pages), `concordia.ca` (archives finding aids), CBC article pages, and `web.archive.org` (entirely refused). Every finding above comes from WebSearch tool snippet/summary extraction, not a directly-read primary source. This caps confidence below "verified from source" for everything in this campaign and should be retried once page-fetch access is restored — particularly for Boyle/Hoade/Garcia, where the most promising untried leads (YMCA Quebec's own staff/history pages, the Concordia YMCA of Montreal fonds sub-series 12A/12B04) are specifically the ones blocked.

### Outcome
- 15 new facts total this campaign (f_1728-f_1742), KB v4.92, 1704 facts.
- Conflict c_014 resolved.
- No stub articles created for Boyle, Hoade, White, or Garcia — single-source oral history (plus, for White, one unconfirmed ambiguous lead) does not meet the bar for a standalone biography per the formal-RALPH requirement for people stubs.
- p_192 (the RALPH research priority) marked completed — null/ambiguous results are a valid completion, not a block, per Phase 2 protocol; a fresh priority should be opened only if/when page-fetch access is restored to retry the specifically-blocked institutional sources.

## Campaign 24 (2026-07-05): Network retest, p_191 ENRICH pass, thesis-lead correction

### Network access retest
Per the `NEXT-SESSION-PROMPT.md` handoff, retested the six previously-403'd hosts before doing anything else: `curl -sS "$HTTPS_PROXY/__agentproxy/status"` showed `recentRelayFailures: []` (clean slate), but direct requests to `ymcaquebec.org`, `linkedin.com`, `facebook.com`, `concordia.ca`, `cbc.ca`, and `web.archive.org` — via both `curl` and the WebFetch tool — all still returned **HTTP 403** (CONNECT tunnel failures / "server returned HTTP 403 Forbidden"). Per `/root/.ccr/README.md`, a 403 from the proxy is an organization policy denial, not to be retried or routed around. Reported to Matt; proceeded to the rest of the queue using WebSearch only, per the handoff's explicit fallback instruction.

### p_191: ENRICH pass on directors-index.md / section-names.md / canoe-trips.md
Cross-checked the 158 photo-mined facts (f_1569-f_1739, from Campaign 22) against `directors-index.md`'s Section and Program Directors table and found that 16 titled section/program-director facts had been extracted into the KB and even summarized narratively in the Campaign 22 log entry, but had never actually been added as article content — a "facts landed in facts.json but never propagated into article text" gap the SESSION-HANDOFF.md explicitly flags as worth checking for. Added:
- **CIT program**: Lynne Robinson ("Directress," 1975), Reiko Webster ("Our Beloved Director," 1992 — herself a named 1986 CIT, showing a camper-to-director career arc), Simon Heller/Paula Cussen/Wendy (1995), Rick Cordi ("CIT Director," 1997), Maria English ("Director"/"CIT Director," 1999-2000, alongside a separately-titled "CIT Program Director: Manuel," surname undocumented).
- **LIT program**: Avigail Aronoff & David Leduc (2002) — the year before Leduc's single-summer on-site Camp Directorship (2004).
- **Rangers**: John Lummis ("co-ordinator," 1959), Louis Lessard & Hélène Longpré (2002), François Goulet-Lessard & [-] Tanguy (2003), Jen Kaufman & Liz Kolinski ("Masters," 2004), Julian Dobie/Hannah S-Paris/Matt Iviott ("Masters," 2005).
- **Voyageurs**: Lorna McNeish ("Capitaine," 2000), Matt Hamerman ("Section Director," 2006).
- **JBC**: Durga Chew-Bose ("S.D.," 2007). **Senior Girls/Lookout**: Bex Finnigan Reisler ("S.D.," 2008).

Added a new "Section and Program Directors" narrative section to `section-names.md` summarizing the same roster with a cross-link to the full table, and a new paragraph to `canoe-trips.md` documenting named trip staff (Rob Shackell as Tripper across 2001/2005/2008/2010 — the longest documented tripping tenure in the plaque archive — plus Steve Wesley, Lorna McNeish, Mark Chamandy-Cook). Flagged two new Open Questions in `directors-index.md`: the unidentified first-names-only "Matt, Laurie" Section Directors on the 2003 JBC plaque (f_1638; "Matt" is a plausible but unconfirmed match for Hamerman), and CIT Program Director Manuel's undocumented surname (2000). No new facts, sources, or conflicts — this was an informal-RALPH content-propagation pass over already-extracted, already-cited facts, not new research. p_191 marked completed in `priorities.json`.

### Correction: the "Concordia Spectrum thesis lead" in NEXT-SESSION-PROMPT.md was stale
The handoff's "Other open threads" section flagged an "incidentally surfaced, not yet ingested" Concordia Spectrum thesis — *"An Experience That Lasts a Lifetime: Building Modernity, Man, and Nation at the YMCA of Montreal's Kamp Kanawana, 1894-1967"* — as a new lead worth adding to `sources/sources.json`. Checking `sources/sources.json` first (per the SESSION-HANDOFF.md rule to always check before ingesting) found this is the **McMorris thesis**, already ingested (`src_mcmorris_thesis`, 2026-02-10) and fully extracted (148 facts, `extraction_version 4.17`) — it is in fact the single most-cited secondary source in the wiki, footnoted `^mc` throughout `section-names.md`, `programs-activities.md`, `canoe-trips.md`, and others. Two additional duplicate source records for the same thesis already exist (`src_mcmorris_thesis_spectrum`, `src_spectrum_mcmorris`) from prior sessions independently re-discovering it. No action needed; noting here so this doesn't get re-flagged as a fresh lead a fourth time.
