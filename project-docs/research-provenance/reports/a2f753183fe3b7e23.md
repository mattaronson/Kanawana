# Agent a2f753183fe3b7e23

**Task:** Search ALL wiki article markdown files in /home/user/Kanawana/wiki/ (recursively in all subdirectories: contex

**Tool uses:** 30

---

Now I have read all the markdown files. Let me compile the complete inventory of open questions.

## COMPLETE INVENTORY OF OPEN QUESTIONS FROM ALL WIKI ARTICLES

Based on my search of all markdown files in the `/home/user/Kanawana/wiki/` directory, here is the complete inventory of open questions:

---

### 1. **The Canadian Camping Movement**
...
### 2. **Daniel Andrew Budge**
**File**: `/home/user/Kanawana/wiki/people/da-budge.md`

1. Did Budge write specifically about the founding of Camp Jubilee or the camping program?
2. Where is Budge buried? Are there other biographical records beyond the McGill archives entry?
3. What was Budge's role in the decision to acquire the Saint-Sauveur site?
4. Are there photographs of Budge?

---

### 3. **Programs and Activities at Kanawana**
...
### 4. **The Cushing Family and YMCA Camping**
...
### 5. **Billy Ball**
**File**: `/home/user/Kanawana/wiki/people/billy-ball.md`
...
### 8. **Places and Locations at Camp Kanawana**
...
### 9. **Stuart McLean**
**File**: `/home/user/Kanawana/wiki/people/stuart-mclean.md`
...
### 11. **Sources and Archives**
**File**: `/home/user/Kanawana/wiki/meta/sources-index.md`
...
### 13. **Hedley Dimock and the Science of Camping**
...
### 14. **The 1967 Centennial and Kanawana**
**File**: `/home/user/Kanawana/wiki/chronology/centennial-1967.md`
...
### 15. **The Council Ring**
**File**: `/home/user/Kanawana/wiki/places/council-ring.md`

1. Does the Council Ring still exist in its 1929 form, or has it been rebuilt since?
2. Are the totem poles still standing? When were they last present? (A 1970s photograph shows at least one totem pole standing.)
3. How did Council Ring ceremonies evolve after the decline of "playing Indian" programming in the 1950s-1960s?

---

### 16. **Harold C. Cross**
**File**: `/home/user/Kanawana/wiki/people/harold-cross.md`
...
3. [Important] What is the full content of the Harold C. Cross-National Council Boys' Work file (1940-1945)? This could clarify his role beyond the Montreal Association.
4. [Nice-to-have] Is there a connection between his camp directorship (1920s) and his later Boys' Work involvement (1940s)?

---

### 17. **Directors and Staff of Camp Kanawana**
...
6. [Nice-to-have] Were Paterson (brochure) and Davis (Gas Bag) both Camp Chiefs in 1923, or did they serve different roles?

---

### 18. **Kanawana Myths and Legends**
...
5. [Nice-to-have] Does the Ralph Dawson 1933 history or the R.L. Charlton 1943 "Early Days" account contain the specific explanation of the name?
6. [Nice-to-have] Do any camp myths appear in the *Green Triangle* newsletters or other camp publications?
7. [Nice-to-have] Are there myths or legends shared with other YMCA camps (Pine Crest, John Island) or with the broader Canadian camping tradition?
...
1. When exactly did the name shift from "Lumberman-Voyageur Week" to "L&V Games"?
2. What is the earliest surviving photograph of L&V Games competition?
3. How has the format changed since the 1950s? Are war canoe races still part of it?
4. When did the L&V Games expand beyond the final week to become associated with the La Vérendrye canoe trip program?

---

### 20. **Kanawana in Wartime (1939-1946)**
**File**: `/home/user/Kanawana/wiki/chronology/wartime-kanawana.md`
...
### 21. **The Kanawana Site**
**File**: `/home/user/Kanawana/wiki/places/the-kanawana-site.md`

1. [Critical] Who was the Page family who sold/donated the land? No biographical information has been found.
2. [Important] Has the camp acreage changed over time? 550 acres is consistently cited in current sources but no historical acreage data exists. McMorris documents the purchase of the **Pagé farm** in 1960 as an expansion of the camp property, though the acreage of that purchase is not specified.
3. [Important] What was the specific reason the Kanawana–Weredale two-site plan was abandoned?
4. [Nice-to-have] Are the 1928 and 1962 maps accessible in the Concordia Archives?
5. [Nice-to-have] Is there any ecological or conservation designation on the property?

---

### 22. **Coeducation and Gender at Kanawana**
**File**: `/home/user/Kanawana/wiki/context/coeducation-gender.md`
...
### 23. **Camp Songs, Cheers, and Musical Traditions**
...
8. [Nice-to-have] Who adapted "Alabama Jubilee" into the Kanawana Marching Song, and when?

---

### 24. **Traditions and Culture at Kanawana**
...
### 25. **Camp Kanawana: Founding and Early History (1892-1923)**
**File**: `/home/user/Kanawana/wiki/chronology/founding-1894.md`
...
### 26. **Canoe Trips at Kanawana**
**File**: `/home/user/Kanawana/wiki/programs/canoe-trips.md`

1. What routes did the earliest 1925 canoe trips follow?
2. Who organized the first La Vérendrye scouting expedition in 1956?
3. When did the La Vérendrye base camp transition from seasonal trips to a permanent satellite operation?
4. What is the current status of the 25-acre Lac Landron lease? Is it still active?
5. When was the formal name "Les Voyageurs de La Vérendrye" adopted and when did it fall out of common usage?

---

### 27. **Section Names at Kanawana**
**File**: `/home/user/Kanawana/wiki/context/section-names.md`

1. When were the section names reassigned along gender lines?
2. When were the additional section names (Rangers, Trailblazers, Foresters, etc.) introduced?
...
- **Total Articles**: 27
- **Total Open Questions**: 168 (across all articles)
- **Critical Priority Questions**: 15
- **Important Priority Questions**: 65
- **Nice-to-have Priority Questions**: 73
- **Partially Resolved Questions**: 4
- **Fully Resolved Questions**: 2

The files are located at the paths specified above in `/home/user/Kanawana/wiki/` and its subdirectories (context/, programs/, people/, places/, chronology/, documents/, meta/).
